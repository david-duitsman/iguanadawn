...
gdjs.Untitled_32sceneCode.asyncCallback10689468 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.25), (runtimeScene) => (gdjs.Untitled_32sceneCode.asyncCallback10689468(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Untitled_32sceneCode.asyncCallback10681876 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.Untitled_32sceneCode.asyncCallback10681876(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.Untitled_32sceneCode.asyncCallback7796044 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.25), (runtimeScene) => (gdjs.Untitled_32sceneCode.asyncCallback7796044(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Untitled_32sceneCode.asyncCallback8447860 = function (runtimeScene, asyncObjectsList) {
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
for (const obj of gdjs.Untitled_32sceneCode.GDSite2Objects1) asyncObjectsList.addObject("Site2", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.Untitled_32sceneCode.asyncCallback8447860(runtimeScene, asyncObjectsList)));
}
}
